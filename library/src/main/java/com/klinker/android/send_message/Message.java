...
public class Message {
     ...
     */
    public void setImage(Bitmap image, String type) {
        this.images = new Bitmap[1];
        this.images[0] = image;

        this.imageTypes = new String[1];
        this.imageTypes[0] = type;
    }
     ...
     */
    public void addImage(Bitmap image, String type) {
        Bitmap[] temp = this.images;
        String[] tempType = this.imageTypes;
        ...
        if (tempType == null) {
            tempType = new String[0];
        }

        this.images = new Bitmap[temp.length + 1];
        this.imageTypes = new String[tempType.length + 1];
        ...
        for (int i = 0; i < tempType.length; i++) {
            this.imageTypes[i] = tempType[i];
        }

        this.images[temp.length] = image;
        this.imageTypes[tempType.length] = type;
    }
     ...
     * @param type is the image's type
     *
